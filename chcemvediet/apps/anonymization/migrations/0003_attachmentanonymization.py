    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(help_text='Empty filename if anonymization failed.', max_length=255, upload_to='attachment_annonymizations', blank=True)),
                ('name', models.CharField(help_text='Attachment anonymization file name, e.g. "document.pdf". Extension automatically adjusted when creating a new object. Empty, if file.name is empty.', max_length=255, blank=True)),
                ('content_type', models.CharField(help_text='Attachment anonymization content type, e.g. "application/pdf". The value may be specified even if anonymization failed.', max_length=255, null=True)),
