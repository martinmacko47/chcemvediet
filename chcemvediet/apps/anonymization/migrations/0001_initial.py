    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Attachment file name, e.g. "document.pdf". Extension automatically adjusted when creating a new object. Is empty, if file is empty.', max_length=255, blank=True)),
