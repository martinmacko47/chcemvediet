...
from poleno.utils.date import naive_date, local_today
...
class DeadlineTest(InforequestsTestCaseMixin, TestCase):
    ...
    def test_deadline_date_property(self):
        deadline = self._create_deadline(base_date=naive_date(u'2010-10-10'), value=8, unit=Deadline.UNITS.CALENDAR_DAYS)
        self.assertEqual(deadline.deadline_date, naive_date(u'2010-10-18'))
        deadline = self._create_deadline(base_date=naive_date(u'2010-10-10'), value=8, unit=Deadline.UNITS.WORKDAYS)
        self.assertEqual(deadline.deadline_date, naive_date(u'2010-10-20'))

    def test_calendar_days_passed_property_and_calendar_days_passed_at_method(self):
        deadline = self._create_deadline(base_date=naive_date(u'2010-10-05'), _today=naive_date(u'2010-10-10'))
        self.assertEqual(deadline.calendar_days_passed, 5)
        self.assertEqual(deadline.calendar_days_passed_at(naive_date(u'2010-10-10')), 5)

    def test_workdays_passed_property_and_workdays_passed_at_method(self):
        deadline = self._create_deadline(base_date=naive_date(u'2010-10-05'), _today=naive_date(u'2010-10-10'))
        self.assertEqual(deadline.workdays_passed, 3)
        self.assertEqual(deadline.workdays_passed_at(naive_date(u'2010-10-10')), 3)

    def test_calendar_days_remaining_property_and_calendar_days_remaining_at_method(self):
        deadline = self._create_deadline(base_date=naive_date(u'2010-10-05'), value=8, unit=Deadline.UNITS.CALENDAR_DAYS, _today=naive_date(u'2010-10-08'))
        self.assertEqual(deadline.calendar_days_remaining, 5)
        self.assertEqual(deadline.calendar_days_remaining_at(naive_date(u'2010-10-08')), 5)

    def test_workdays_remaining_property_and_workdays_remaining_at_method(self):
        deadline =  self._create_deadline(base_date=naive_date(u'2010-10-05'), value=8, unit=Deadline.UNITS.CALENDAR_DAYS, _today=naive_date(u'2010-10-08'))
        self.assertEqual(deadline.workdays_remaining, 3)
        self.assertEqual(deadline.workdays_remaining_at(naive_date(u'2010-10-08')), 3)

    def test_calendar_days_behind_property_and_calendar_days_behind_at_method(self):
        deadline = self._create_deadline(base_date=naive_date(u'2010-10-05'), value=8, unit=Deadline.UNITS.CALENDAR_DAYS, _today=naive_date(u'2010-10-26'))
        self.assertEqual(deadline.calendar_days_behind, 13)
        self.assertEqual(deadline.calendar_days_behind_at(naive_date(u'2010-10-26')), 13)

    def test_workdays_behind_property_and_workdays_behind_at_method(self):
        deadline = self._create_deadline(base_date=naive_date(u'2010-10-05'), value=8, unit=Deadline.UNITS.CALENDAR_DAYS, _today=naive_date(u'2010-10-26'))
        self.assertEqual(deadline.workdays_behind, 9)
        self.assertEqual(deadline.workdays_behind_at(naive_date(u'2010-10-26')), 9)

    def test_is_deadline_missed_property_and_is_deadline_missed_at_method(self):
        tests = (                            # _today,                    is_deadline_missed
        ...
        for unit, _today, is_deadline_missed in tests:
            deadline = self._create_deadline(base_date=naive_date(u'2010-10-05'), value=8, unit=unit, _today=_today)
            self.assertEqual(deadline.is_deadline_missed, is_deadline_missed)
            self.assertEqual(deadline.is_deadline_missed_at(_today), is_deadline_missed)

    def test_snooze_date_property(self):
        deadline = self._create_deadline(base_date=naive_date(u'2010-10-05'), value=8, unit=Deadline.UNITS.CALENDAR_DAYS, snooze=naive_date(u'2010-10-14'))
        self.assertEqual(deadline.snooze_date, naive_date(u'2010-10-14'))
        deadline = self._create_deadline(base_date=naive_date(u'2010-10-05'), value=8, unit=Deadline.UNITS.CALENDAR_DAYS, snooze=naive_date(u'2010-10-12'))
    ...
    def test_is_snoozed_property(self):
        deadline = self._create_deadline(base_date=naive_date(u'2010-10-05'), value=8, unit=Deadline.UNITS.CALENDAR_DAYS, snooze=naive_date(u'2010-10-14'))
        self.assertTrue(deadline.is_snoozed)
        deadline = self._create_deadline(base_date=naive_date(u'2010-10-05'), value=8, unit=Deadline.UNITS.CALENDAR_DAYS, snooze=naive_date(u'2010-10-12'))
        self.assertFalse(deadline.is_snoozed)
    ...
    def test_snooze_calendar_days_remaining_property_and_snooze_calendar_days_remaining_at_method(self):
        deadline = self._create_deadline(base_date=naive_date(u'2010-10-05'), value=8, unit=Deadline.UNITS.CALENDAR_DAYS, snooze=naive_date(u'2010-10-18'), _today=naive_date(u'2010-10-08'))
        self.assertEqual(deadline.snooze_calendar_days_remaining, 10)
        self.assertEqual(deadline.snooze_calendar_days_remaining_at(naive_date(u'2010-10-08')), 10)
    ...
    def test_snooze_workdays_remaining_property_and_snooze_workdays_remaining_at_method(self):
        ...
        self.assertEqual(deadline.snooze_workdays_remaining_at(naive_date(u'2010-10-08')), 6)

    def test_snooze_calendar_days_behind_property_and_snooze_calendar_days_behind_at_method(self):
        deadline = self._create_deadline(base_date=naive_date(u'2010-10-05'), value=8, unit=Deadline.UNITS.CALENDAR_DAYS, snooze=naive_date(u'2010-10-18'), _today=naive_date(u'2010-10-25'))
        self.assertEqual(deadline.snooze_calendar_days_behind, 7)
        self.assertEqual(deadline.snooze_calendar_days_behind_at(naive_date(u'2010-10-25')), 7)
    ...
    def test_snooze_workdays_behind_property_and_snooze_workdays_behind_at_method(self):
        ...
        self.assertEqual(deadline.snooze_workdays_behind_at(naive_date(u'2010-10-25')), 5)

    def test_is_snooze_missed_property_and_is_snooze_missed_at_methods(self):
        deadline = self._create_deadline(base_date=naive_date(u'2010-10-05'), value=8, unit=Deadline.UNITS.CALENDAR_DAYS, snooze=naive_date(u'2010-10-25'), _today=naive_date(u'2010-10-26'))
        self.assertTrue(deadline.is_snooze_missed)
        self.assertTrue(deadline.is_snooze_missed_at(naive_date(u'2010-10-26')))
        deadline = self._create_deadline(base_date=naive_date(u'2010-10-05'), value=8, unit=Deadline.UNITS.CALENDAR_DAYS, snooze=naive_date(u'2010-10-25'), _today=naive_date(u'2010-10-24'))
        self.assertFalse(deadline.is_snooze_missed)
        self.assertFalse(deadline.is_snooze_missed_at(naive_date(u'2010-10-24')))

    def test_repr(self):
        deadline = self._create_deadline(type=Deadline.TYPES.APPLICANT_DEADLINE, base_date=naive_date(u'2010-10-05'), value=8, unit=Deadline.UNITS.CALENDAR_DAYS, snooze=naive_date(u'2010-10-25'))
        self.assertEqual(repr(deadline), u'<Deadline: 8 CD for Applicant since 2010-10-05 +12 CD>')
        deadline = self._create_deadline(type=Deadline.TYPES.OBLIGEE_DEADLINE, base_date=naive_date(u'2010-10-05'), value=8, unit=Deadline.UNITS.WORKDAYS, snooze=None)
        self.assertEqual(repr(deadline), u'<Deadline: 8 WD for Obligee since 2010-10-05>')
