...
class RenderMailTest(TestCase):
    ...
    def setUp(self):
        ...
        self.tempdir.write(u'third_message.html', u'<html><body><p>Third message with only HTML</p></body></html>\n')
        ...
        self.tempdir.write(u'sixth_message.html', u'<html><body><p>HTML message with dictionary: {{ variable }}</p></body></html>\n')
    ...
    def test_message_with_html_only(self):
        ...
        alternatives = self._get_alternatives(msg)
        self.assertEqual(alternatives, [
            (u'text/html', u'<html><body><p>Third message with only HTML</p></body></html>'),
            ])
    ...
    def test_render_mail_with_dictionary(self):
        ...
        self.assertEqual(alternatives, [
            ...
            (u'text/html', u'<html><body><p>HTML message with dictionary: 47</p></body></html>'),
            ])
